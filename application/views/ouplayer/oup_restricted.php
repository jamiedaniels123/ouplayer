...
<html lang="en">
<meta charset="utf-8" />
<title><?=$meta->title ?> | <?=$restrict_text ?> | <?=t('OU player') ?>
</title>
...
?>
<body id="ouplayer"
	class="oup mode-embed restrict access-<?=$restrict_class ?>">
	...
	<?php /*<a class="ou-home" href="http://www.open.ac.uk/"><img class="logo" alt="The Open University" src="<?=site_url('assets/0.gif') ?>" height="38" width="32" /></a>*/ ?>
		<img class="ou-home logo" alt="Open University logo"
			src="<?=site_url('assets/0.gif') ?>" height="38" width="32" />
		<ul class="mediatitle">
			<li><h1>
			<?=$meta->title; /*substr_replace($meta->title, '…', 62)*/ ?>
				</h1></li>
			...
			<li><a target="_blank"
				href="https://msds.open.ac.uk/signon/SAMSDefault/SAMS001_Default.aspx?URL=<?=/*urlencode*/($popup_url) ?>"
				class="login popout"><?=t('Log in and launch the player in a new window') ?>
			</a></li>
			...
			<li><a class="about" href="<?=$about_url ?>"
				title="<?=t('New window') ?>"><?=t('About the player') ?> </a></li>
		</ul>
	</div>
